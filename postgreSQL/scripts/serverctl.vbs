...
Select Case strAction
    ...
    Case "reload"
         iRet = DoCmd("""C:\workSpace\Nomadcode-Project\nomadClone-Project\postgreSQL\bin\pg_ctl.exe"" -D ""C:\workSpace\Nomadcode-Project\nomadClone-Project\postgreSQL\data"" reload")
    Case "restart"
	     iRet = DoCmd("""" & strWinDir & """\System32\net stop postgresql-x64-14")
		 If iRet = 0 Then
		     iRet = DoCmd("""" & strWinDir & """\System32\net start postgresql-x64-14")
